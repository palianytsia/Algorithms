 ...
 * <ul>
 * <li>Given a composite systems comprised of randomly distributed insulating and metallic materials: what fraction of
 * the materials need to be metallic so that the composite system is an electrical conductor?</li>
 * <li>Given a porous landscape with water on the surface (or oil below), under what conditions will the water be able
 * to drain through to the bottom (or the oil to gush through to the surface)?</li>
 * </ul>
 * 
 * @see <a href="http://coursera.cs.princeton.edu/algs4/assignments/percolation.html">Programming Assignment 1:
 *      Percolation</a> from "Algorithms, Part I" course by <i>Kevin Wayne</i> and <i>Robert Sedgewick</i> for detailed
 *      problem description.
 * 
...
public class Percolation {
     ...
     * 
     * <p>
     * A full site is an open site that can be connected to an open site in the top row via a chain of neighbouring
     * (left, right, up, down) open sites.
     * </p>
     * <p>
     * By convention, the row and column indices i and j are integers between 1 and N, where (1, 1) is the upper-left
     * site.
     * </p>
     * 
     * @param i
	...
	// site is full if and only if it is an open site and is connected to a virtual top site
	...
	// special treatment for top and bottom row sites, in order to connect them to virtual neighbours
	if (i == 1) {
     ...
     * 
     * <p>
     * The system percolates if there is a full site in the bottom row. In other words, a system percolates if we fill
