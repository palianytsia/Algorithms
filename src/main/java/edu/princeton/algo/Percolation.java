 ...
 * <ul>
 * <li>Given a composite systems comprised of randomly distributed insulating
 * and metallic materials: what fraction of the materials need to be metallic so
 * that the composite system is an electrical conductor?</li>
 * <li>Given a porous landscape with water on the surface (or oil below), under
 * what conditions will the water be able to drain through to the bottom (or the
 * oil to gush through to the surface)?</li>
 * </ul>
 * 
 * @see <a
 *      href="http://coursera.cs.princeton.edu/algs4/assignments/percolation.html">Programming
 *      Assignment 1: Percolation</a> from "Algorithms, Part I" course by
 *      <i>Kevin Wayne</i> and <i>Robert Sedgewick</i> for detailed problem
 *      description.
 * 
...
public class Percolation {
	...
	/**
	 * Create a new percolation system using an N-by-N grid of sites. Initially
	 ...
	 * top row via a chain of neighbouring (left, right, up, down) open sites.
	 * </p>
	 * <p>
	 ...
	 * 
	 * <p>
	 * The system percolates if there is a full site in the bottom row. In other
	...
	/**
	 * Converts two-dimensional index into sequence number for usage in union
	 * data structure.
	 * <p>
	 * For example, in a 5x5 grid the site in the third row and second column
	 * has sequence number 12 (5 + 5 + 2).
	 * </p>
	 */
