...
public class Deque<Item> implements Iterable<Item> {
	...
	public void addFirst(Item item) {
		if (item == null) {
			throw new NullPointerException(
					"Null value cannot be inserted to the deque.");
		}
		if (isEmpty()) {
	...
	/**
	 * Returns an iterator over the items in order from front to end. The
	...
	/**
	 * A basic component of a linked list, which in turn is an underlying data
	 ...
	 * 
	 * @param <Item>
	 *            - type of the values that linked list built with this nodes
	 *            can hold.
	 */
	...
	/**
	 * Provides a way to iterate over items in a deque, which internally is
	 * backed up by a linked list.
	 * 
	 * @author Ivan Palianytsia <a
	 *         href="mailto:ivan.palianytsia@gmail.com">ivan.palianytsia</a>
	 * 
	...
	private static class LinkedListIterator<Item> implements Iterator<Item> {
		...
		/**
		 * Given a pointer to linked list's head item constructs a new iterator
		 * over this linked list.
		 * 
		 * @param head
		 *            - first item in the linked list, can't be null.
		 * @NullPointerException if the given pointer to linked list's head is
		 *                       null.
		 */
