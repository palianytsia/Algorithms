 ...
 *      "Algorithms, Part I" course by <i>Kevin Wayne</i> and <i>Robert Sedgewick</i> for detailed description.
 * 
...
public class Subset {
    ...
    /**
     * Takes a command-line integer k; reads in a sequence of N strings from standard input using StdIn.readString(); and prints out exactly k of them,
