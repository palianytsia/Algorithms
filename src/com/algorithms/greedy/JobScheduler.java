...
/**
 * Job scheduling showcase. Demonstrates different greedy algorithms for minimizing the weighted sum of job completion
 * times.
 * 
...
public class JobScheduler {
    ...
    public enum Approach implements Comparator<Job> {
        ...
        /**
         * Approach that schedules jobs in decreasing order of the difference (weight - length), if two jobs have equal
         * difference (weight - length), you schedules the job with higher weight first. This algorithm is not always
         * optimal.
         */
        DIFFERENCE {
            @Override
    ...
    /**
     * Schedules the given set of jobs trying to achieve optimal schedule (the one that minimizes the weighted sum of
     * completion times) using the suggested greedy approach.
     * 
     * @param jobs
