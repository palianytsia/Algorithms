...
/**
 * The Bellman-Ford algorithm solves the single-source shortest-path problem. While slower than Dijkstra's algorithm, it
 * accommodates negative edge lengths and is also better suited for distributed implementations.
 * 
