 ...
 * <li>Repeat the steps above for the remainder of the list (starting at the
 * second position and advancing each time).</li>
 * </ul>
 * 
 * <p>
...
public class SelectionSort {
	...
	public static void sort(int[] array) {
		...
		System.out.println("Array of " + array.length
				+ " elements sorted via Selection sort with " + comparisons
				+ " comparisons.");
	}

	/**
	 * Selects an element into a given position in order to sort the given
	 * array, assuming that elements coming before this position are already
	 * sorted.
	 * 
	 * @param array
	 *            - array being sorted.
	 * 
	 * @param position
	 *            - position to select the element for, elements before this
	 *            position should be already sorted.
	 * 
