...
/**
 * A double-ended queue or deque is a generalization of a stack and a queue that supports inserting and removing items
...
public class Deque<Item> implements Iterable<Item> {
    ...
    /**
     * Returns an iterator over the items in order from front to end. The returned iterator <strong>does not
